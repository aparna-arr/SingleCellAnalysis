...
#mtecdev.qc <- computeSumFactors(mtecdev.qc, sizes=seq(20, 80, 5))
...
write.table(cl.df, file="communities.txt", quote=FALSE, row.names=FALSE, col.names=FALSE, sep="\t")
...
plotExpression(mtecdev.qc, rownames(hvg.out)[1:50]) 
